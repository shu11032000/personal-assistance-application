...
using namespace std;
void wishme(){
    //System's default time and date
    time_t now = time(0);
        ...
        if(strcmp(password, "jarvis")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by my master Yash !!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master Yash";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
        ...
        else
                {
                    ...
                    cout << "\t\t\t<============================= YOU CAN CALL ME ANTHING YOU LIKE  =============================>" << endl;
